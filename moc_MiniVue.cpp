...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MiniVue_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MiniVue_t qt_meta_stringdata_MiniVue = {
    {
QT_MOC_LITERAL(0, 0, 7), // "MiniVue"
QT_MOC_LITERAL(1, 8, 14), // "trace_viewport"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13) // "rect_viewport"
...
void MiniVue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->trace_viewport((*reinterpret_cast< QRectF(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject MiniVue::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_MiniVue.data,
